local Cannonwar_Map_ID = 326

Event_Add("Cannonwar_Event_Blockchange", "Cannonwar_Event_Blockchange", "Map_Block_Change_Client", 0, 0, Cannonwar_Map_ID)
...
Event_Add("Cannonwar_Event_Entity_Die", "Cannonwar_Event_Entity_Die", "Entity_Die", 1, 0, -1)
function Cannonwar_Event_Entity_Die(Result, Entity_ID)
	local Player_Number = Entity_Get_Player(Entity_ID)
	...
	if Map_ID == Cannonwar_Map_ID then
